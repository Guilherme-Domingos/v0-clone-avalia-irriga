...
export default function NovoSetorHidraulico({
  params,
}: {
            ...
            <form onSubmit={handleSubmit} className='space-y-6'>
              <div className='space-y-4'>
                ...
                <div className='space-y-2'>
                  <Label htmlFor='identificacao'>
                    Identificação do setor hidráulico *
                  </Label>
                  <Input
                    id='identificacao'
              ...
              <div className='space-y-4'>
                ...
                <div className='space-y-2'>
                  ...
                  <Select
                    value={formData.tipoEmissor}
                    onValueChange={(value) =>
                      handleChange('tipoEmissor', value)
                    }>
                    <SelectTrigger>
                ...
                <div className='space-y-2'>
                  <Label htmlFor='fabricanteEmissor'>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleChange('fabricanteEmissor', e.target.value)
                    }
                  />
                </div>
                ...
                <div className='space-y-2'>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleChange('modeloEmissor', e.target.value)
                    }
                  />
                </div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                  <div className='space-y-2'>
                    <Label htmlFor='vazaoNominal'>
                      Vazão nominal do emissor (L/h) *
                    </Label>
                    <Input
                      id='vazaoNominal'
                      type='number'
                      ...
                      onChange={(e) =>
                        handleChange('vazaoNominal', e.target.value)
                      }
                      required
                    />
                  </div>
                  ...
                  <div className='space-y-2'>
                    <Label htmlFor='pressaoTrabalho'>
                      Pressão de trabalho do emissor (mca) *
                    </Label>
                    <Input
                      id='pressaoTrabalho'
                      type='number'
                      ...
                      onChange={(e) =>
                        handleChange('pressaoTrabalho', e.target.value)
                      }
                      required
                    />
                  </div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                  <div className='space-y-2'>
                    <Label htmlFor='distanciaEmissores'>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleChange('distanciaEmissores', e.target.value)
                      }
                      required
                    />
                  </div>
                  ...
                  <div className='space-y-2'>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleChange('distanciaLinhas', e.target.value)
                      }
                      required
                    />
                  </div>
                ...
                <div className='space-y-2'>
                  <Label htmlFor='numeroEmissores'>
                    Número de emissores no setor
                  </Label>
                  <Input
                    id='numeroEmissores'
                    type='number'
                    ...
                    onChange={(e) =>
                      handleChange('numeroEmissores', e.target.value)
                    }
                  />
                </div>
              </div>
              ...
              <div className='space-y-4'>
                <h2 className='text-lg font-medium'>
                  Sistema de Filtragem e Controle
                </h2>
                ...
                <div className='space-y-2'>
                  <Label htmlFor='malhaFiltro'>
                    Malha do filtro / grau de filtragem
                  </Label>
                  <Input
                    id='malhaFiltro'
                    value={formData.malhaFiltro}
                    onChange={(e) =>
                      handleChange('malhaFiltro', e.target.value)
                    }
                ...
                <div className='space-y-2'>
                  <Label htmlFor='pressaoEntrada'>
                    Pressão de entrada no setor (mca) *
                  </Label>
                  <Input
                    id='pressaoEntrada'
                    type='number'
                    ...
                    onChange={(e) =>
                      handleChange('pressaoEntrada', e.target.value)
                    }
                    required
                  />
                </div>
                ...
                <div className='space-y-2'>
                  <Label htmlFor='tipoValvula'>
                    Tipo de válvula de controle
                  </Label>
                  <Select
                    value={formData.tipoValvula}
                    onValueChange={(value) =>
                      handleChange('tipoValvula', value)
                    }>
                    <SelectTrigger>
              ...
              <div className='space-y-4'>
                ...
                <div className='space-y-2'>
                  <Label htmlFor='condicoesGerais'>
                    Condições gerais do setor
                  </Label>
                  <Select
                    value={formData.condicoesGerais}
                    onValueChange={(value) =>
                      handleChange('condicoesGerais', value)
                    }>
                    <SelectTrigger>
                ...
                <div className='space-y-2'>
                  <Label htmlFor='frequenciaManutenção'>
                    Frequência de manutenção / lavagem
                  </Label>
                  <Select
                    value={formData.frequenciaManutenção}
                    onValueChange={(value) =>
                      handleChange('frequenciaManutenção', value)
                    }>
                    <SelectTrigger>
