...
// Tipos de emissão
const tiposEmissao = ["Spray fixo", "Spray rotativo", "Difusor", "I-Wob", "LDN", "Super Spray", "Outro"]

// Tipos de energia
const tiposEnergia = ["Elétrica monofásica", "Elétrica trifásica", "Diesel", "Solar", "Outro"]

// Tipos de controle
const tiposControle = ["Manual", "Automático", "Remoto", "Computadorizado", "Outro"]

// Tipos de fonte hídrica
const tiposFonteHidrica = ["Rio", "Açude", "Poço", "Barragem", "Canal", "Outro"]

// Tipos de bocal
const tiposBocal = ["Fixo", "Regulável", "Rotativo", "Outro"]

// Frequências de manutenção
const frequenciasManutenção = ["Mensal", "Trimestral", "Semestral", "Anual", "Outro"]
    ...
    return (
      <div className="flex flex-col min-h-screen bg-gray-50">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">Carregando dados do pivô central...</div>
        </div>
      </div>
    )
  }
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="numeroTorres">Número de torres móveis *</Label>
                  <Input
                    id="numeroTorres"
                    type="number"
                    min="0"
                    value={formData.numeroTorres}
                    onChange={(e) => handleChange("numeroTorres", Number.parseInt(e.target.value))}
                    required
                  />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="comprimentoTotal">Comprimento total do pivô (m) *</Label>
                  <Input
                    id="comprimentoTotal"
                    type="number"
                    min="0"
                    ...
                    onChange={(e) => handleChange("comprimentoTotal", Number.parseFloat(e.target.value))}
                    required
                  />
                </div>
              </div>
            ...
            <div className="space-y-4">
              <h2 className="text-lg font-medium">Informações do Fabricante</h2>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="tipoEmissao">Tipo de emissão (emissores) *</Label>
                <Select value={formData.tipoEmissao} onValueChange={(value) => handleChange("tipoEmissao", value)}>
                  <SelectTrigger>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="potenciaMotor">Potência do motor (cv) *</Label>
                  <Input
                    id="potenciaMotor"
                    type="number"
                    min="0"
                    ...
                    onChange={(e) => handleChange("potenciaMotor", Number.parseFloat(e.target.value))}
                    required
                  />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="vazaoOperacao">Vazão de operação (m³/h) *</Label>
                  <Input
                    id="vazaoOperacao"
                    type="number"
                    min="0"
                    ...
                    onChange={(e) => handleChange("vazaoOperacao", Number.parseFloat(e.target.value))}
                    required
                  />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="pressaoOperacao">Pressão de operação na entrada (mca) *</Label>
                  <Input
                    id="pressaoOperacao"
                    type="number"
                    min="0"
                    ...
                    onChange={(e) => handleChange("pressaoOperacao", Number.parseFloat(e.target.value))}
                    required
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="tipoControle">Tipo de controle do pivô *</Label>
                <Select value={formData.tipoControle} onValueChange={(value) => handleChange("tipoControle", value)}>
                  <SelectTrigger>
              ...
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) => handleChange("possuiFertirrigacao", checked)}
                />
                <Label htmlFor="fertirrigacao">Possui sistema de fertirrigação?</Label>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="tipoFonteHidrica">Tipo de fonte hídrica</Label>
                <Select
                  value={formData.tipoFonteHidrica}
                  onValueChange={(value) => handleChange("tipoFonteHidrica", value)}
                >
                  <SelectTrigger>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="tempoFuncionamento">Tempo médio de funcionamento (h/dia)</Label>
                  <Input
                    ...
                    onChange={(e) => handleChange("tempoFuncionamento", Number.parseFloat(e.target.value))}
                  />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="velocidadeDeslocamento">Velocidade média de deslocamento (%)</Label>
                  <Input
                    ...
                    onChange={(e) => handleChange("velocidadeDeslocamento", Number.parseFloat(e.target.value))}
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Select value={formData.tipoBocal} onValueChange={(value) => handleChange("tipoBocal", value)}>
                    <SelectTrigger>
                ...
                <div className="space-y-2">
                  <Label htmlFor="pressaoBocais">Pressão de operação dos bocais (mca)</Label>
                  <Input
                    id="pressaoBocais"
                    type="number"
                    min="0"
                    ...
                    onChange={(e) => handleChange("pressaoBocais", Number.parseFloat(e.target.value))}
                  />
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="dataUltimaManutencao">Data da última manutenção preventiva</Label>
                  <Input
                ...
                <div className="space-y-2">
                  <Label htmlFor="frequenciaManutencao">Frequência de manutenção</Label>
                  <Select
                    value={formData.frequenciaManutencao}
                    onValueChange={(value) => handleChange("frequenciaManutencao", value)}
                  >
                    <SelectTrigger>
              ...
              <div className="space-y-2">
                <Label htmlFor="problemasObservados">Problemas observados</Label>
                <Textarea
                  id="problemasObservados"
                  value={formData.problemasObservados}
                  onChange={(e) => handleChange("problemasObservados", e.target.value)}
                  rows={3}
            ...
            <div className="pt-4 space-y-3">
              ...
              <Button
                ...
                onClick={() => {
                  if (confirm("Tem certeza que deseja excluir este pivô central? Esta ação não pode ser desfeita.")) {
