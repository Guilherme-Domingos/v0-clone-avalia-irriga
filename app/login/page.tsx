    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-white">
      <div className="w-full max-w-md p-6 space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <button
            className="mt-4 w-full flex items-center justify-center gap-2 border border-gray-300 rounded-md py-2 px-4 text-sm font-medium text-gray-700 hover:bg-gray-50"
            onClick={() => {
        ...
        <div className="text-center">
          ...
          <Link href="/cadastro" className="text-sm text-teal-600 hover:underline">
            Criar conta
          </Link>
        </div>
      </div>
